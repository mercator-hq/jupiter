...
// It implements the providers.Provider interface for OpenAI's API.
...
// SendCompletion sends a completion request to OpenAI.
...
// StreamCompletion sends a streaming completion request to OpenAI.
